    ...
    function __ShowSnow(settings)
{
    ...
    var doc_width = (document.width !== undefined) ? document.width : document.body.offsetWidth - 10;
     console.log('docHeight=> ',doc_height, '---', doc_width);
    dx = [];
    xp = [];
    yp = [];
    am = [];
    ...
    for (i = 0; i < no; ++i) 
    {
        ...
        flake.append("<img src='" + snowsrc + "' style='width:"+Math.random()*100 +"%'>");
        flake.appendTo("body");
